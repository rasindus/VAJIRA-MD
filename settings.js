...
const BOTNAME = 'RASINDU-MD|-WA-BOT™';
const FOOTERNAME = '> R A S I N D U -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '9426785433' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=TJFnyARK#BhM0GQ3dWna8kE4ErUS1GUiJoAVUPNJghcVwd6wfAc4' ,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 R A S I N D U -  ＭＤ - Ｖ5 👨‍💻',    
